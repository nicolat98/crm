            ...
            async submitForm() {
                ...
                if(!this.errors.length){
                    ...
                    .then(response => {
                        ...
                        axios
                        .post('/api/v1/teams/add_member/', userData)
                        .then(response => {
                        ...
                        .catch(error =>{
                            if (error.response){
                                for(const property in error.response.data){
                                    this.errors.push('Adding Member Error : Something went wrong. Please try again. Maybe your password is too weak.')
                                }
